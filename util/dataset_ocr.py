...
class SemData(Dataset):
    ...
    def __getitem__(self, index):
        ...
        small_target = F.interpolate(new_label.unsqueeze(0).unsqueeze(0).float(), size=(new_image.shape[2]//8, new_image.shape[2]//8), mode='bilinear', align_corners=True).squeeze().long()
        ...
        #     hrnet_index = [0, 2, 259, 260, 415, 324, 9, 258, 144, 18, 19, 22, 
