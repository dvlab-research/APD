...
def main():
    ...
    if not args.has_prediction:
        if args.arch == 'psp':
            from model.pspnet import Model
            model = Model(layers=args.layers, classes=args.classes, zoom_factor=args.zoom_factor, pretrained=False, args=args)
        elif args.arch == 'pspmv2':
            from model.pspnet_mv2 import Model
            model = Model(layers=args.layers, classes=args.classes, zoom_factor=args.zoom_factor, pretrained=False, args=args)
        elif args.arch == 'pspeffnet':
            from model.pspnet_effnet import Model
            model = Model(layers=args.layers, classes=args.classes, zoom_factor=args.zoom_factor, pretrained=False, args=args)
        elif args.arch == 'deeplabv3':
            from model.deeplabv3 import Model
            model = Model(layers=args.layers, classes=args.classes, zoom_factor=args.zoom_factor, pretrained=False, args=args)
        elif args.arch == 'deeplabv3mv2':
            from model.pspnet_mv2 import Model
            model = Model(layers=args.layers, classes=args.classes, zoom_factor=args.zoom_factor, pretrained=False, args=args, use_aspp=True)
